...
function get_sections_assigned_to($username, $semester, $year) {
  return mysql_query("select * from full_sections where inst_username='$username' and semester='$semester' and year='$year';");
}
